...
//            return "Date";
    ...
    public static void main(String[] args) {  
        ...
        new GenEntityOracle("goods","Goods","1703c").init();  
        new GenEntityOracle("brand","Brand","1703c").init();  
        new GenEntityOracle("cate_brand","Cate_Brand","1703c").init();  
        new GenEntityOracle("category","Category","1703c").init();  
    }  
}